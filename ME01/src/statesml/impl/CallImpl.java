 ...
 * </p>
 * <ul>
 *   <li>{@link statesml.impl.CallImpl#getFunction <em>Function</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CallImpl extends MinimalEObjectImpl.Container implements Call {
	...
	protected EClass eStaticClass() {
		return StatesmlPackage.Literals.CALL;
	}
	...
	public EList<Function> getFunction() {
		if (function == null) {
			function = new EObjectContainmentEList<Function>(Function.class, this, StatesmlPackage.CALL__FUNCTION);
		}
		return function;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StatesmlPackage.CALL__FUNCTION:
